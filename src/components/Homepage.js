		...
		<>
			<div className="px-[20px] py-[10px] w-[1200px] max-[1100px]:w-[80%] max-[800px]:w-[90%] max-[600px]:w-[100%] mx-[auto]">
				...
				<div id="aboutus" className="text-center">
					...
					<div className="min-[1000px]:flex justify-between">
						<div className="w-[300px] border-[#67778870] border-[1px] border-solid rounded-[10px] p-[20px] max-[1000px]:mx-[auto]">
							...
							<div className="text-[18px] font-semibold leading-[28px] text-[#1E2022] my-[40px]">Building your vision together</div>
							<div className="text-[16px] text-[#677788]">AIMS specializes in nurturing early-stage and expanding businesses. We're sector-agnostic experts passionate about transforming ideas into successful enterprises.</div>
						</div>
						<div className="w-[300px] max-[999px]:my-[30px] min-[1000px]:mx-[20px] border-[#67778870] border-[1px] border-solid rounded-[10px] p-[20px] max-[1000px]:mx-[auto]">
							<div className="flex justify-center">
							...
							<div className="text-[18px] font-semibold leading-[28px] text-[#1E2022] my-[40px]">Our Approach</div>
							<div className="text-[16px] text-[#677788]"> From setting up your initial team to strategic marketing and financial planning, AIMS is dedicated to ensuring your startup achieves product-market fit and robust early revenue growth.</div>
						</div>
						<div className="w-[300px] border-[#67778870] border-[1px] border-solid rounded-[10px] p-[20px] max-[1000px]:mx-[auto]">
							<div className="flex justify-center">
							...
							<div className="text-[18px] font-semibold leading-[28px] text-[#1E2022] my-[40px]">Sector Agnostic Expertise</div>
							<div className="text-[16px] text-[#677788]">AIMS is adept across various sectors, including Fintech, Sportstech, MedTech, Edutech, Deeptech, and more. This broad expertise enables us to provide unique insights and tailored solutions for each startup, regardless of their industry.</div>
						</div>
					</div>
				</div>
				...
				<div id="ourservices" className="text-center">
					...
					<div className="grid min-[1100px]:grid-cols-3 min-[700px]:grid-cols-2 grid-cols-1 gap-[20px]">
						<div className="shadow-[1px_4px_5px_1px_rgba(0,0,0,0.3)] p-[20px] text-left rounded-[10px]">
